...
laplacian_calculation_type             = 1 # (Not calculated (0), Finite element projection (1), Superconvergent recovery(2))
...
print_FLUID_VEL_LAPL_PROJECTED_option      = 1
print_FLUID_VEL_LAPL_RATE_PROJECTED_option = 1
...
print_VELOCITY_LAPLACIAN_option            = 1
print_VELOCITY_LAPLACIAN_RATE_option       = 1
...
#
problem_name="D_DEMPack2_Tutorial_4"
