...
class FluidDynamicsAnalysisProblemZero(FluidDynamicsAnalysis):
    ...
    def __init__(self,model,project_parameters):
        ...
        self.washout_time_coefficient = 140.0/project_parameters["problem_data"]["end_time"].GetDouble()
    ...
    def FinalizeSolutionStep(self):
        ...
        if (self.time >= self.washout_time_coefficient*self.project_parameters["problem_data"]["end_time"].GetDouble()): # burning time
            self.project_parameters["solver_settings"]["time_stepping"]["time_step"].SetDouble(0.02)
        else:
            self.project_parameters["solver_settings"]["time_stepping"]["time_step"].SetDouble(0.05)
