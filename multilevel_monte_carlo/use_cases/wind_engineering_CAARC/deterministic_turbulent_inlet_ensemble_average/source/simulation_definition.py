...
class SimulationScenario(FluidDynamicsAnalysisMC):
    def __init__(self,input_model,input_parameters,sample):
        ...
        print("[SCREENING] burn-in time coefficient simulation scenario analysis = Tbt / T =",self.burnin_time_coefficient)
    ...
    def ModifyInitialProperties(self):
        ...
        random_rough_height = max(1e-10,self.sample[2]) # ensure not having negative roughness height
        ...
        # self.project_parameters["processes"]["boundary_conditions_process_list"][0]["Parameters"]["roughness_height"].SetDouble(random_rough_height)
