...
mdpa_path_to_replace=( $mdpa_path_to_replace_1 $mdpa_path_to_replace_2 $mdpa_path_to_replace_3 $mdpa_path_to_replace_4 $mdpa_path_to_replace_5 $mdpa_path_to_replace_6 $mdpa_path_to_replace_7 $mdpa_path_to_replace_8 )
mdpa_new_path=( $mdpa_new_path_1 $mdpa_new_path_2 $mdpa_new_path_3 $mdpa_new_path_4 $mdpa_new_path_5 $mdpa_new_path_6 $mdpa_new_path_7 $mdpa_new_path_8 )
...
do
    ...
    sed -i "s|${mdpa_path_to_replace[i-1]}|${mdpa_new_path[i-1]}|g" "../problem_settings/parameters_level_$i.json"
done
...
do
    ...
    sed -i "s|${mdpa_new_path[i-1]}|${mdpa_path_to_replace[i-1]}|g" "../problem_settings/parameters_level_$i.json"
done