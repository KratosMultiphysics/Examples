...
For this geometry, the flow features of greatest interest are typically concentrated:

- near the front stagnation region
- around the roof and side edges
- in the near wake behind the vehicle
- in any separated shear layers generated by the immersed geometry
