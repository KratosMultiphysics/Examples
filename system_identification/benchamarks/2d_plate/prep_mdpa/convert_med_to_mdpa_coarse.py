...
KratosMED.MedModelPartIO("plate_mm_offset_z_coarse.med", Kratos.ModelPartIO.READ | Kratos.ModelPartIO.MESH_ONLY).ReadModelPart(Structure)
...
Kratos.ModelPartIO("Structure_coarse", Kratos.ModelPartIO.MESH_ONLY | Kratos.ModelPartIO.WRITE).WriteModelPart(Structure)
