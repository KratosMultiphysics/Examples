...
parser.add_argument("--remove_output_processes", type=bool, default=False)
...
if args.courant_number is not None:
    parameters['solver_settings']['time_stepping']['courant_number'].SetBool(args.courant_number)
...
if args.remove_output_processes:
