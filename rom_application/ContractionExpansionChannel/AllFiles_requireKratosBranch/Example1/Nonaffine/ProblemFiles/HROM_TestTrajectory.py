...
class HROMClass_test(ROM_Class_test):
    ...
    def ModifyInitialGeometry(self):
        ...
        OriginalNumberOfElements = 5152 #TODO, get rid of this, load both elements and condition sets
...
def HROM(residuals_svd_truncation_tolerance=1e-4, svd_truncation_tolerance=1e-4):
    ...
    if not os.path.exists(f'./Results/HROM_test_{svd_truncation_tolerance}_{residuals_svd_truncation_tolerance}.post.bin'):
...
def prepare_files(working_path,svd_truncation_tolerance,residuals_svd_truncation_tolerance):
    ...
    with open(working_path+'/ProblemFiles/ProjectParameters.json','r') as f:
        ...
        updated_project_parameters["output_processes"]["gid_output"][0]["Parameters"]["output_name"] = working_path +f'/Results/HROM_test_{svd_truncation_tolerance}_{residuals_svd_truncation_tolerance}'
